...
\begin{itemize}
  ...
  \item \textbf{Eight defects, found by building the gate.} Five in the search: a stale
        ...
        enhanced both players, and matches that stopped on the statistic under test. In a
        controlled match the side searching three times harder went from 0 wins in 40 games
        to 24 (\cref{sec:pipeline-found}). This is the strongest argument in this report
